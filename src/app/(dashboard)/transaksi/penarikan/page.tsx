// src/app/(dashboard)/penarikan/page.tsx
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4">
        ...
        <div>
          ...
          <p className="text-xs text-amber-700 mt-0.5 leading-relaxed">
            Pencairan hanya dilakukan sekali setahun sebelum Lebaran. Jumlah yang dicairkan maksimal sama dengan saldo aktif nasabah.
            Setelah dicatat, saldo nasabah otomatis berkurang. Kirim notifikasi WA setelah pencairan dicatat.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
        <div className="border-b border-gray-50 px-5 py-4">
          <p className="text-sm font-semibold text-gray-800">Nasabah yang Punya Saldo (Siap Dicairkan)</p>
        </div>
        {nasabahList.length === 0 ? (
          <div className="py-10 text-center text-sm text-gray-400">Semua saldo sudah dicairkan atau belum ada transaksi.</div>
        ) : (
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="bg-amber-50">
                <td colSpan={2} className="px-5 py-3 text-right font-semibold text-amber-800">Total yang harus disiapkan</td>
